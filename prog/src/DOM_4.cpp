...
DepthOfMarket_4::DepthOfMarket_4() {
    counter = 0;
}
...
size_t DepthOfMarket_4::add_order(const Order& new_order) {
...
bool DepthOfMarket_4::edit_order(size_t index, float new_price, uint64_t new_amount, order_book_type new_type) {
...
bool DepthOfMarket_4::delete_order(size_t delete_index) {
...
const Order* DepthOfMarket_4::get_order(size_t order_index) {
...
std::vector<Order> DepthOfMarket_4::get_DOM() {
    return DOM;
}

void DepthOfMarket_4::set_DOM(std::vector<Order> new_DOM) {
    counter = 0;
    DOM.clear();
...
std::pair<std::vector<Order>, std::vector<Order>> DepthOfMarket_4::show_10_best(){
